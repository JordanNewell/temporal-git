...
| Package | npm | What |
|---------|-----|------|
| [`packages/core`](https://github.com/JordanNewell/temporal-git/tree/master/packages/core) | `@temporal-git/core` | The `BisectEngine` — shared by both surfaces so behavior can't drift |
| [`packages/cli`](https://github.com/JordanNewell/temporal-git/tree/master/packages/cli) | `temporal-git` | The CLI |
| [`packages/vscode`](https://github.com/JordanNewell/temporal-git/tree/master/packages/vscode) | `jordannewell.temporal-git` (marketplace) | The VS Code extension |
...
MIT — see [LICENSE](https://github.com/JordanNewell/temporal-git/blob/master/LICENSE).
